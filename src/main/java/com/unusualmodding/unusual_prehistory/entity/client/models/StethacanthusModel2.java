...
public class StethacanthusModel2<T extends StethacanthusEntityTest> extends HierarchicalModel<T> {
	...
	@Override
	public void setupAnim(StethacanthusEntityTest entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.root().getAllParts().forEach(ModelPart::resetPose);

		this.animate(entity.swimAnimationState, StethacanthusAnimations.SWIM, ageInTicks, limbSwingAmount * 4f);
		this.animate(entity.idleAnimationState, StethacanthusAnimations.IDLE, ageInTicks, 1.0F);
