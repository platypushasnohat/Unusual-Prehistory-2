...
public class TelecrexPreenGoal extends AnimationGoal {
    ...
    public boolean canUse() {
        return super.canUse() && this.telecrex.getPreenCooldown() == 0 && !this.telecrex.isInWater() && !this.telecrex.isFlying();
    }
    ...
    public void stop() {
        super.stop();
        this.telecrex.setPreenCooldown(40 * 2 * 20 + telecrex.getRandom().nextInt(20 * 8 * 20));
    }
