...
public class UP2ChestBoatEntity extends ChestBoat implements UP2BoatType {

    public UP2ChestBoatEntity(EntityType type, Level level) {
        super(type, level);
        this.blocksBuilding = true;
    }

    public UP2ChestBoatEntity(PlayMessages.SpawnEntity spawnEntity, Level level) {
        this(UP2Entities.CHEST_BOAT.get(), level);
        this.setBoundingBox(this.makeBoundingBox());
    }

    public UP2ChestBoatEntity(Level level, double x, double y, double z) {
        this(UP2Entities.CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
    ...
    public UP2ChestBoatEntity(Level level, Vec3 location, UP2BoatType.Type type) {
