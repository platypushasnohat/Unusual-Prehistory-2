...
public class SyncItemStackC2SPacket {

    private final ItemStackHandler itemStackHandler;
    private final BlockPos pos;

    public SyncItemStackC2SPacket(ItemStackHandler itemStackHandler, BlockPos pos) {
        this.itemStackHandler = itemStackHandler;
        this.pos = pos;
    }

    public SyncItemStackC2SPacket(FriendlyByteBuf buf) {
