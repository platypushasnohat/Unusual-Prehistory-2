...
public class SarraceniaBlock extends AncientFlowerBlock implements BonemealableBlock {

    public SarraceniaBlock(Supplier<MobEffect> effect, int duration, BlockBehaviour.Properties properties) {
    ...
    public void performBonemeal(ServerLevel level, RandomSource source, BlockPos pos, BlockState state) {
        AncientTallPlantBlock doubleplantblock = (AncientTallPlantBlock) (UP2Blocks.TALL_SARRACENIA.get());
