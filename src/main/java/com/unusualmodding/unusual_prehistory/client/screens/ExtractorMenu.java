...
public class ExtractorMenu extends AbstractContainerMenu {
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 35, 52));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 53, 52));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 71, 52));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 89, 52));
            this.addSlot(new SlotItemHandler(iItemHandler, 6, 107, 52));
            this.addSlot(new SlotItemHandler(iItemHandler, 7, 125, 52));
        });
