...
public class SuspiciousStoneRenderer implements BlockEntityRenderer<SuspiciousStoneBlockEntity> {

    private final ItemRenderer itemRenderer;

    public SuspiciousStoneRenderer(BlockEntityRendererProvider.Context context) {
        this.itemRenderer = context.getItemRenderer();
    }

    @Override
    public void render(SuspiciousStoneBlockEntity blockEntity, float f, PoseStack poseStack, MultiBufferSource bufferSource, int p_277463_, int p_277346_) {
