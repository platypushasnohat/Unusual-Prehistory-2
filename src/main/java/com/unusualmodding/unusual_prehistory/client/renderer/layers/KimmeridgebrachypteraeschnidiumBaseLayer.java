...
@OnlyIn(Dist.CLIENT)
public class KimmeridgebrachypteraeschnidiumBaseLayer extends RenderLayer<KimmeridgebrachypteraeschnidiumEntity, KimmeridgebrachypteraeschnidiumModel<KimmeridgebrachypteraeschnidiumEntity>> {

    public KimmeridgebrachypteraeschnidiumBaseLayer(RenderLayerParent<KimmeridgebrachypteraeschnidiumEntity, KimmeridgebrachypteraeschnidiumModel<KimmeridgebrachypteraeschnidiumEntity>> renderer) {
        super(renderer);
    }

    public ResourceLocation baseTextures(KimmeridgebrachypteraeschnidiumEntity entity) {
