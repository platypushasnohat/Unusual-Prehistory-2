...
public class ScaumenaciaModel<T extends Scaumenacia> extends UP2Model<T> {
	...
	@Override
	public void setupAnim(Scaumenacia entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
