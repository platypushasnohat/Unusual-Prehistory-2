...
public class CultivatorMenu extends AbstractContainerMenu {
    ...
    public CultivatorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(UP2MenuTypes.CULTIVATOR_MENU.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, UP2Blocks.CULTIVATOR.get());
    }
