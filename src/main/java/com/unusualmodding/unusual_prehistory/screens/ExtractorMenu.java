...
public class ExtractorMenu extends AbstractContainerMenu {
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(UP2MenuTypes.EXTRACTOR_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new UP2BottleSlot(handler, 0, 33, 5));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, UP2Blocks.EXTRACTOR.get());
    }
    ...
    private static class UP2BottleSlot extends SlotItemHandler {
        public UP2BottleSlot(IItemHandler itemHandler, int index, int x, int y) {
