...
public class CultivatingRecipe implements Recipe<SimpleContainer> {

    private final ResourceLocation resourceLocation;
    private final ItemStack output;
    private final NonNullList<Ingredient> ingredients;

    public CultivatingRecipe(ResourceLocation resourceLocation, ItemStack output, NonNullList<Ingredient> ingredients) {
    ...
    public static class Serializer implements RecipeSerializer<CultivatingRecipe> {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf data, CultivatingRecipe recipe) {
