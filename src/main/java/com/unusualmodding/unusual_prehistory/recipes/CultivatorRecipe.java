...
public class CultivatorRecipe implements Recipe<SimpleContainer> {
    ...
    public CultivatorRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<CultivatorRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(UnusualPrehistory2.MOD_ID,"cultivator");
        @Override
