...
public class UP2BlockTags {
    ...
    public static final TagKey<Block> BARINASUCHUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/barinasuchus_spawnable_on");
    public static final TagKey<Block> BRACHIOSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/brachiosaurus_spawnable_on");
    public static final TagKey<Block> CARNOTAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/carnotaurus_spawnable_on");
    public static final TagKey<Block> DESMATOSUCHUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/desmatosuchus_spawnable_on");
    public static final TagKey<Block> DIMORPHODON_SPAWNABLE_ON = modBlockTag("spawnable_blocks/dimorphodon_spawnable_on");
    public static final TagKey<Block> DIPLOCAULUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/diplocaulus_spawnable_on");
    public static final TagKey<Block> DROMAEOSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/dromaeosaurus_spawnable_on");
    public static final TagKey<Block> HIBBERTOPTERUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/kaprosuchus_spawnable_on");
    public static final TagKey<Block> KAPROSUCHUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/kaprosuchus_spawnable_on");
    public static final TagKey<Block> KENTROSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/kentrosaurus_spawnable_on");
    public static final TagKey<Block> KIMMERIDGEBRACHYPTERAESCHNIDIUM_SPAWNABLE_ON = modBlockTag("spawnable_blocks/kimmeridgebrachypteraeschnidium_spawnable_on");
    public static final TagKey<Block> LEPTICTIDIUM_SPAWNABLE_ON = modBlockTag("spawnable_blocks/leptictidium_spawnable_on");
    public static final TagKey<Block> LYSTROSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/lystrosaurus_spawnable_on");
    public static final TagKey<Block> MAJUNGASAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/majungasaurus_spawnable_on");
    public static final TagKey<Block> MANIPULATOR_SPAWNABLE_ON = modBlockTag("spawnable_blocks/manipulator_spawnable_on");
    public static final TagKey<Block> MEGALANIA_SPAWNABLE_ON = modBlockTag("spawnable_blocks/megalania_spawnable_on");
    public static final TagKey<Block> PACHYCEPHALOSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/pachycephalosaurus_spawnable_on");
    public static final TagKey<Block> PRAEPUSA_SPAWNABLE_ON = modBlockTag("spawnable_blocks/praepusa_spawnable_on");
    public static final TagKey<Block> PSILOPTERUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/psilopterus_spawnable_on");
    public static final TagKey<Block> PTERODACTYLUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/pterodactylus_spawnable_on");
    public static final TagKey<Block> TALPANAS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/talpanas_spawnable_on");
    public static final TagKey<Block> TELECREX_SPAWNABLE_ON = modBlockTag("spawnable_blocks/telecrex_spawnable_on");
    public static final TagKey<Block> THERIZINOSAURUS_SPAWNABLE_ON = modBlockTag("spawnable_blocks/therizinosaurus_spawnable_on");
