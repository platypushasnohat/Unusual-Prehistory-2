...
public class UP2ModelLayers {
    ...
    public static final ModelLayerLocation AEGIROCASSIS_BABY = main("aegirocassis_baby");
    ...
    public static final ModelLayerLocation BRACHIOSAURUS_BABY = main("brachiosaurus_baby");
    ...
    public static final ModelLayerLocation HIBBERTOPTERUS = main("hibbertopterus");
    ...
    public static final ModelLayerLocation PALAEOPHIS = main("palaeophis");
