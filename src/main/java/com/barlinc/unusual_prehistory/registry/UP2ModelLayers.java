...
public class UP2ModelLayers {
    ...
    public static final ModelLayerLocation GASTRIC_BROODING_FROG = mainLayer("gastric_brooding_frog");
    public static final ModelLayerLocation GASTRIC_BROODING_FROGLET = mainLayer("gastric_brooding_froglet");
    ...
    public static final ModelLayerLocation SHRINGASAURUS = mainLayer("shringasaurus");
    ...
    public static final ModelLayerLocation PACHYRHINOSAURUS = mainLayer("pachyrhinosaurus");
