...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Thylacine>> THYLACINE = registerEntity("thylacine", Thylacine::new, MobCategory.CREATURE, builder -> builder.sized(0.9F, 0.8F).eyeHeight(0.7F).clientTrackingRange(10));
