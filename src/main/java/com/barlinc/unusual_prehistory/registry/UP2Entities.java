...
public class UP2Entities {
    ...
    // Update 1
    public static final DeferredHolder<EntityType<?>, EntityType<Carnotaurus>> CARNOTAURUS = registerEntity("carnotaurus", Carnotaurus::new, MobCategory.CREATURE, builder -> builder.sized(1.6F, 2.9F).eyeHeight(2.8F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Diplocaulus>> DIPLOCAULUS = registerEntity("diplocaulus", Diplocaulus::new, MobCategory.CREATURE, builder -> builder.sized(0.6F, 0.4F).eyeHeight(0.3F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Dunkleosteus>> DUNKLEOSTEUS = registerEntity("dunkleosteus", Dunkleosteus::new, MobCategory.WATER_CREATURE, builder -> builder.sized(0.4F, 0.5F).eyeHeight(0.3F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Kentrosaurus>> KENTROSAURUS = registerEntity("kentrosaurus", Kentrosaurus::new, MobCategory.CREATURE, builder -> builder.sized(1.6F, 2.2F).eyeHeight(0.9F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Kimmeridgebrachypteraeschnidium>> KIMMERIDGEBRACHYPTERAESCHNIDIUM = registerEntity("kimmeridgebrachypteraeschnidium", Kimmeridgebrachypteraeschnidium::new, MobCategory.CREATURE, builder -> builder.sized(0.5F, 0.5F).eyeHeight(0.3F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<KimmeridgebrachypteraeschnidiumNymph>> KIMMERIDGEBRACHYPTERAESCHNIDIUM_NYMPH = registerEntity("kimmeridgebrachypteraeschnidium_nymph", KimmeridgebrachypteraeschnidiumNymph::new, MobCategory.CREATURE, builder -> builder.sized(0.5F, 0.5F).eyeHeight(0.3F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Coelacanthus>> COELACANTHUS = registerEntity("coelacanthus", Coelacanthus::new, MobCategory.WATER_CREATURE, builder -> builder.sized(0.5F, 0.5F).eyeHeight(0.27F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Kaprosuchus>> KAPROSUCHUS = registerEntity("kaprosuchus", Kaprosuchus::new, MobCategory.CREATURE, builder -> builder.sized(0.9F, 1.3F).eyeHeight(0.8F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Leptictidium>> LEPTICTIDIUM = registerEntity("leptictidium", Leptictidium::new, MobCategory.CREATURE, builder -> builder.sized(0.4F, 0.7F).eyeHeight(0.5F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<LobeFinnedFish>> LOBE_FINNED_FISH = registerEntity("lobe_finned_fish", LobeFinnedFish::new, MobCategory.WATER_AMBIENT, builder -> builder.sized(0.5F, 0.8F).eyeHeight(0.5F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Pterodactylus>> PTERODACTYLUS = registerEntity("pterodactylus", Pterodactylus::new, MobCategory.CREATURE, builder -> builder.sized(0.6F, 0.6F).eyeHeight(0.9F).clientTrackingRange(10));
    public static final DeferredHolder<EntityType<?>, EntityType<Ulughbegsaurus>> ULUGHBEGSAURUS = registerEntity("ulughbegsaurus", Ulughbegsaurus::new, MobCategory.CREATURE, builder -> builder.sized(1.3F, 2.4F).eyeHeight(0.9F).clientTrackingRange(10));
