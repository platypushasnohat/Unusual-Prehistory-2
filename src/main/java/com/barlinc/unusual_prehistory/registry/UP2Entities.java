...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Bananogmius>> BANANOGMIUS = registerEntity("bananogmius", Bananogmius::new, MobCategory.WATER_CREATURE, builder -> builder.sized(1.25F, 1.5F).eyeHeight(0.75F).clientTrackingRange(10));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Pachyrhinosaurus>> PACHYRHINOSAURUS = registerEntity("pachyrhinosaurus", Pachyrhinosaurus::new, MobCategory.CREATURE, builder -> builder.sized(3.0F, 3.8F).eyeHeight(3.6F).clientTrackingRange(10));
