...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Arthropleura>> ARTHROPLEURA = registerEntity("arthropleura", Arthropleura::new, MobCategory.CREATURE, builder -> builder.sized(1.4F, 0.8F).eyeHeight(0.4F).clientTrackingRange(10).setShouldReceiveVelocityUpdates(true));
    public static final DeferredHolder<EntityType<?>, EntityType<ArthropleuraPart>> ARTHROPLEURA_PART = registerEntity("arthropleura_part", ArthropleuraPart::new, MobCategory.MISC, builder -> builder.sized(1.4F, 0.8F).clientTrackingRange(10).noSummon().setShouldReceiveVelocityUpdates(true));
