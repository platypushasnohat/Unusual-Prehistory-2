...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GastricBroodingFrog>> GASTRIC_BROODING_FROG = registerEntityNoLang("gastric_brooding_frog", GastricBroodingFrog::new, MobCategory.CREATURE, builder -> builder.sized(0.8F, 0.8F).passengerAttachments(new Vec3(0.0, 0.375, -0.25)).clientTrackingRange(10));
