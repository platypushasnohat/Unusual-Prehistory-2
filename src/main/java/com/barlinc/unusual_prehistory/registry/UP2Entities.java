...
public class UP2Entities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Hesperornis>> HESPERORNIS = registerEntity("hesperornis", Hesperornis::new, MobCategory.WATER_CREATURE, builder -> builder.sized(0.8F, 1.2F).eyeHeight(0.6F).clientTrackingRange(10));
