...
import com.barlinc.unusual_prehistory.entity.effects.Fury;
...
public class UP2MobEffects {
    ...
    public static final DeferredHolder<MobEffect, MobEffect> FURY = MOB_EFFECTS.register("fury", Fury::new);
