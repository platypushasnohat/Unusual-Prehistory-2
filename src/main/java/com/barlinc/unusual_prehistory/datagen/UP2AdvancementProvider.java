...
public class UP2AdvancementProvider implements AdvancementGenerator {
    ...
    public void generate(@NotNull Provider provider, @NotNull Consumer<Advancement> consumer, @NotNull ExistingFileHelper helper) {
        ...
        createAdvancement("breed_holocene_mobs", root, Items.HANGING_ROOTS, FrameType.TASK, false)
        ...
        createAdvancement("pacify_mob", root, Items.ENCHANTED_GOLDEN_APPLE, FrameType.CHALLENGE, false)
        ...
        Advancement ordovicianRoot = this.addAllEggs(Advancement.Builder.advancement().parent(paleozoicRoot).display(UP2Items.PALEOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.ordovician_root"), Component.translatable("advancement.unusual_prehistory.ordovician_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("ordovician_root"), helper);
        Advancement silurianRoot = this.addAllEggs(Advancement.Builder.advancement().parent(paleozoicRoot).display(UP2Items.PALEOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.silurian_root"), Component.translatable("advancement.unusual_prehistory.silurian_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("silurian_root"), helper);
        Advancement devonianRoot = this.addAllEggs(Advancement.Builder.advancement().parent(paleozoicRoot).display(UP2Items.PALEOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.devonian_root"), Component.translatable("advancement.unusual_prehistory.devonian_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("devonian_root"), helper);
        Advancement carboniferousRoot = this.addAllEggs(Advancement.Builder.advancement().parent(paleozoicRoot).display(UP2Items.PALEOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.carboniferous_root"), Component.translatable("advancement.unusual_prehistory.carboniferous_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("carboniferous_root"), helper);
        Advancement permianRoot = this.addAllEggs(Advancement.Builder.advancement().parent(paleozoicRoot).display(UP2Items.PALEOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.permian_root"), Component.translatable("advancement.unusual_prehistory.permian_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("permian_root"), helper);
        ...
        Advancement jurassicRoot = this.addAllEggs(Advancement.Builder.advancement().parent(mesozoicRoot).display(UP2Items.MESOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.jurassic_root"), Component.translatable("advancement.unusual_prehistory.jurassic_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("jurassic_root"), helper);
        Advancement cretaceousRoot = this.addAllEggs(Advancement.Builder.advancement().parent(mesozoicRoot).display(UP2Items.MESOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.cretaceous_root"), Component.translatable("advancement.unusual_prehistory.cretaceous_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
        ...
        Advancement paleogeneRoot = this.addAllEggs(Advancement.Builder.advancement().parent(cenozoicRoot).display(UP2Items.CENOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.paleogene_root"), Component.translatable("advancement.unusual_prehistory.paleogene_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("paleogene_root"), helper);
        Advancement neogeneRoot = this.addAllEggs(Advancement.Builder.advancement().parent(cenozoicRoot).display(UP2Items.CENOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.neogene_root"), Component.translatable("advancement.unusual_prehistory.neogene_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("neogene_root"), helper);
        Advancement quaternaryRoot = this.addAllEggs(Advancement.Builder.advancement().parent(cenozoicRoot).display(UP2Items.CENOZOIC_FOSSIL.get(), Component.translatable("advancement.unusual_prehistory.quaternary_root"), Component.translatable("advancement.unusual_prehistory.quaternary_root.desc"), null, FrameType.TASK, false, false, false)
                .requirements(RequirementsStrategy.OR))
                .save(consumer, UnusualPrehistory2.modPrefix("quaternary_root"), helper);
        ...
        Advancement reviveTelecrex = reviveMobAdvancement("revive_telecrex", reviveLeptictidium, UP2Items.TELECREX_EGG.get(), UP2Entities.TELECREX.get()).save(consumer, UnusualPrehistory2.modPrefix("revive_telecrex"), helper);
