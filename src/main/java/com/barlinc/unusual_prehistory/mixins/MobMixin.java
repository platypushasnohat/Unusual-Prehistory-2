...
@Mixin(Mob.class)
public abstract class MobMixin extends LivingEntity implements EntityDropsAccessor {

    @Shadow protected abstract void dropCustomDeathLoot(@NotNull DamageSource source, int looting, boolean hitByPlayer);
