...
public class SmoothAmphibiousPathNavigation extends AmphibiousPathNavigation {

    private final float distanceModifier;

    public SmoothAmphibiousPathNavigation(Mob mob, Level level) {
        this(mob, level, 0.75F);
    }

    public SmoothAmphibiousPathNavigation(Mob mob, Level level, float distanceModifier) {
        super(mob, level);
