...
public class SmoothBodyRotationControl2 extends BodyRotationControl {
    ...
    public SmoothBodyRotationControl2(Mob entity) {
        super(entity);
        this.entity = entity;
    }
...
//                if (Math.abs(this.entity.yHeadRot - this.lastStableYHeadRot) > 15.0F) {
//                    this.headStableTime = 0;
//                    this.lastStableYHeadRot = this.entity.yHeadRot;
...
//    }
    ...
    protected boolean isMoving() {
        ...
        return d0 * d0 + d1 * d1 > MOVE_THRESHOLD;
    }
}
