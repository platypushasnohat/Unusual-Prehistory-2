...
public class SemiAquaticSwimmingMoveControl extends MoveControl {

    private final int maxTurnX;
    private final int maxTurnY;
    private final float inWaterSpeedModifier;

    public SemiAquaticSwimmingMoveControl(Mob mob, int maxTurnX, int maxTurnY, float speedModifier) {
        super(mob);
