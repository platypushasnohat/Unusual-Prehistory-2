...
public class AnimationGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        return prehistoricMob.isAlive() && prehistoricMob.getIdleState() == 0 && !prehistoricMob.isMobEepy() && !prehistoricMob.isDancing();
    }
    ...
    public boolean canContinueToUse() {
        ...
        return !prehistoricMob.isDancing() && !prehistoricMob.isMobEepy() && prehistoricMob.getTarget() == null && timer > 0 && prehistoricMob.isAlive() && prehistoricMob.getIdleState() == idleState;
    }
