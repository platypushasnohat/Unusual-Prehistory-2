...
public class AnimationGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        return prehistoricMob.isAlive() && prehistoricMob.getIdleState() == 0 && !prehistoricMob.isMobEepy();
    }
    ...
    public boolean canContinueToUse() {
        ...
        return !prehistoricMob.isMobEepy() && prehistoricMob.getTarget() == null && timer > 0 && prehistoricMob.isAlive() && prehistoricMob.getIdleState() == idleState;
    }
