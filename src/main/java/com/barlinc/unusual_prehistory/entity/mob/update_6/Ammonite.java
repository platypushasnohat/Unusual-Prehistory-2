...
public class Ammonite extends SchoolingAquaticMob implements Bucketable, VariantHolder<Ammonite.AmmoniteVariant> {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.2D, Ingredient.of(UP2ItemTags.AMMONITE_FOOD), false));
        this.goalSelector.addGoal(4, new CustomizableRandomSwimGoal(this, 1.0D, 80, 10, 7));
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(UP2ItemTags.AMMONITE_FOOD);
    }
