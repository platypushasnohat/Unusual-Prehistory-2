...
public class MosasaurusPart extends PartEntity<Mosasaurus> {

    public final Mosasaurus parent;
    private final EntityDimensions dimensions;
    private final Entity connectedTo;

    public MosasaurusPart(Mosasaurus parent, Entity connectedTo, float width, float height) {
        super(parent);
        this.parent = parent;
