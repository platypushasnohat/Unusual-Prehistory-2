...
public class PoppingBubbleParticle extends TextureSheetParticle {
    ...
    protected PoppingBubbleParticle(ClientLevel level, double x, double y, double z, double xspeed, double yspeed, double zspeed, SpriteSet sprites) {
        super(level, x, y, z);
    ...
    public static class BubbleFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public BubbleFactory(SpriteSet sprites) {
            this.sprites = sprites;
        }
        ...
        public Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level, double x, double y, double z, double xspeed, double yspeed, double zspeed) {
            return new PoppingBubbleParticle(level, x, y, z, xspeed, yspeed, zspeed, sprites);
        }
    }
}