...
public class PsilopterusModel extends UP2Model<Psilopterus> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = body_main.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 16).addBox(-3.5F, -6.5F, -7.5F, 7.0F, 7.0F, 10.0F, new CubeDeformation(0.1F))
                .texOffs(0, 33).addBox(-3.5F, -6.5F, 0.5F, 7.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(34, 36).addBox(-2.5F, -10.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition foot_r1 = left_leg3.addOrReplaceChild("foot_r1", CubeListBuilder.create().texOffs(46, 12).addBox(-2.5F, -0.01F, -2.0F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4538F, 0.0F, 0.0F));
        ...
        PartDefinition foot_r2 = right_leg3.addOrReplaceChild("foot_r2", CubeListBuilder.create().texOffs(46, 12).mirror().addBox(-2.5F, -0.01F, -2.0F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4538F, 0.0F, 0.0F));
    ...
    public void setupAnim(Psilopterus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.swimAnimationState, PsilopterusAnimations.SWIM, ageInTicks, 1 + limbSwingAmount * 4);
