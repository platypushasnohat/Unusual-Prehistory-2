...
public class KaprosuchusAnimations {
    ...
    public static final AnimationDefinition SIT_END = AnimationDefinition.Builder.withLength(1.0F)
            ...
            .addAnimation("left_leg3", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(-15.0F, -27.5F, 20.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("right_leg1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-110.0F, 20.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition RUN = AnimationDefinition.Builder.withLength(0.5F).looping()
            ...
            .addAnimation("left_arm2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.2361F, KeyframeAnimations.posVec(0.0F, -2.0F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
                    ...
                    new Keyframe(0.3889F, KeyframeAnimations.posVec(0.0F, -2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, -2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.4444F, KeyframeAnimations.posVec(0.0F, -2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("right_arm1", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(-3.0F, 4.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("right_arm2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.2778F, KeyframeAnimations.posVec(0.0F, -2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.3056F, KeyframeAnimations.posVec(0.0F, -2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
