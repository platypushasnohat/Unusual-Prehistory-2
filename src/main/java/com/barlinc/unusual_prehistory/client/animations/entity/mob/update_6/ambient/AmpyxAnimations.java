package com.barlinc.unusual_prehistory.client.animations.entity.mob.update_6.ambient;
...
public class AmpyxAnimations {
    ...
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
            ...
            .addAnimation("body_main", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.9583F, KeyframeAnimations.posVec(-0.25F, 0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    ...
                    new Keyframe(2.4583F, KeyframeAnimations.posVec(-0.25F, 0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.5417F, KeyframeAnimations.posVec(0.25F, 0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.5833F, KeyframeAnimations.posVec(1.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.9167F, KeyframeAnimations.posVec(1.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.9583F, KeyframeAnimations.posVec(0.25F, 0.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
