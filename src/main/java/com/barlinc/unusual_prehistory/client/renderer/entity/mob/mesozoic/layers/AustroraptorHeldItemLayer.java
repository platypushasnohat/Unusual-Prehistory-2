...
@OnlyIn(Dist.CLIENT)
public class AustroraptorHeldItemLayer extends RenderLayer<Austroraptor, AustroraptorModel> {

    public AustroraptorHeldItemLayer(RenderLayerParent<Austroraptor, AustroraptorModel> parent) {
        super(parent);
    }

    @Override
    public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, Austroraptor entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
