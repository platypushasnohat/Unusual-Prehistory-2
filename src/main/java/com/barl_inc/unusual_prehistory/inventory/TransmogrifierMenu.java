package com.barl_inc.unusual_prehistory.inventory;
...
public class TransmogrifierMenu extends AbstractContainerMenu {
    ...
    public TransmogrifierMenu(int syncId, Inventory playerInventory, Container container, ContainerData data) {
        super(UP2Menus.TRANSMOGRIFIER.get(), syncId);
        this.container = container;
        this.data = data;
        this.level = playerInventory.player.level();
        this.addSlot(new Slot(container, 0, 37, 31));
        this.addSlot(new TransmogrifierFuelSlot(this, container, 1, 82, 59));
    ...
    protected boolean canTransmogrify(ItemStack stack) {
        return this.level.getRecipeManager().getRecipeFor(UP2RecipeTypes.TRANSMOGRIFICATION.get(), new SingleRecipeInput(stack), this.level).isPresent();
    }
    ...
    public static class TransmogrifierFuelSlot extends Slot {

        private final TransmogrifierMenu menu;

        public TransmogrifierFuelSlot(TransmogrifierMenu menu, Container inventory, int index, int x, int y) {
