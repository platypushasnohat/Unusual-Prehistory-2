...
public class AbandonedLabStructure extends Structure {

    public static final MapCodec<AbandonedLabStructure> CODEC = AbandonedLabStructure.simpleCodec(AbandonedLabStructure::new);

    public AbandonedLabStructure(StructureSettings settings) {
        super(settings);
    }
    ...
    protected Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (this.isSufficientlyFlat(context, pos, 2)) {
            return Optional.of(new GenerationStub(pos, pieces -> AbandonedLabStructurePiece.addPieces(context.structureTemplateManager(), pos, pieces, random)));
        }
        return Optional.empty();
    }
