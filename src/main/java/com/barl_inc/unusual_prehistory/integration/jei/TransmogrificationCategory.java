...
public class TransmogrificationCategory implements IRecipeCategory<TransmogrificationRecipe> {
    ...
    public final static ResourceLocation UID = UnusualPrehistory2.location("transmogrification");
    public final static ResourceLocation BACKGROUND = UnusualPrehistory2.location("textures/gui/transmogrifier.png");
    ...
    public TransmogrificationCategory(IGuiHelper guiHelper) {
        ...
        this.fuel = guiHelper.drawableBuilder(BACKGROUND, 176, 0, TransmogrifierScreen.FUEL_WIDTH, TransmogrifierScreen.FUEL_HEIGHT).buildAnimated(1200, IDrawableAnimated.StartDirection.RIGHT, true);
